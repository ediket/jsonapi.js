...
let isValidAttrs = function (data) {
...
class Resource extends Model {
  ...
  setLink (key, resource) {
    ...
    let url = _.isString(resource) ? resource : resource.getLink('self');
    this.links[key] = url;
  ...
  removeLink (key) {
    ...
    let removedLink = this.links[key];
  ...
  deserialize () {
    ...
    let data = _.clone(this.attributes, true);
